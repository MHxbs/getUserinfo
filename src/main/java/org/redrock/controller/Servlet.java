    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       resp.setCharacterEncoding("UTF-8");
        try {
            ...
            String openid=messageBean.getFromUserName();
            User user= UserInfoUtil.getUserInfo(openid);
            if (messageBean.getContent().equals("game")){
                xml= XmlUtil.createXml(messageBean.getFromUserName(),messageBean.getToUserName(),"你好"+user.getNickname());
